...
<div class="author-box">
    ...
    <div>
        ...
        <p><?php echo esc_html( get_the_author_meta( 'description', $author_id ) ? get_the_author_meta( 'description', $author_id ) : __( 'Writer at this blog.', 'genrolla' ) ); ?></p>
        <a href="<?php echo esc_url( get_author_posts_url( $author_id ) ); ?>" class="btn btn-ghost" style="margin-top:10px;padding:7px 16px;font-size:13px">
            <?php esc_html_e( 'View all posts', 'genrolla' ); ?> <i class="fa-solid fa-arrow-right"></i>
        </a>
    </div>
</div>
